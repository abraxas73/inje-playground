...
- **지금 수신**은 예약 여부와 관계없이 최근 24시간 수집분을 본인에게 보냅니다. 인증된 계정 이메일만 필요합니다. 예약 발송 시각·일일 발송 슬롯·마지막 성공 기준은 바뀌지 않아 소식이 중복 포함될 수 있습니다.
...
- 배포 SQL: `docs/sql/2026-09-11-yonhap-notice-send-now.sql` → `2026-09-16-yonhap-notice-smtp.sql`.

...
- `rfp_projects`(사업 개요·상태·정규화 키, `category_summary` jsonb = 요구사항 총괄표 행 — SQL `2026-09-07-rfp-category-summary.sql`), `rfp_files`(원본, sha256 유니크), `rfp_requirements`(구분 코드·ID·7필드·solution) — SQL `docs/sql/2026-09-03-rfp-analyzer.sql`

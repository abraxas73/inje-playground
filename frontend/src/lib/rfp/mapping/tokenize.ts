...
export const STOPWORDS: ReadonlySet<string> = new Set([
  ...
  // 운영 튜닝(2026-09-07): 첫 매핑에서 후보를 끌었던 범용어
  "대상", "화면", "요약", "주요", "연결", "구현", "분석", "등록", "정의", "확인", "따른", "따라", "안전하게", "규정", "여부", "이상", "이하", "각각", "모든", "전체", "별도", "기타", "통해", "위해", "대해", "제공한다", "수행한다", "가능한", "있어야", "한다", "있다", "된다", "합니다", "개발", "적용", "수립", "작성", "제출", "준수",

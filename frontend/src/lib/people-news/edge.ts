 ...
 */
export async function callYonhapFunction(supabase: SupabaseClient, action: YonhapAction, options: { timeoutMs: number; failureMessage: string }, fetcher: typeof fetch = fetch): Promise<YonhapCallResult> {

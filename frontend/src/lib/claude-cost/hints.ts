...
export const MISSING_HINT = "그 달 말까지 시작한(첫 인보이스의 서비스 기간 시작이 그 달 이전인) Team 조직 중 서비스 기간이 그 달을 덮는 인보이스가 없는 조직입니다(기간이 없는 장은 발행 월). 시작 전 달은 누락이 아니고, 연간 플랜 조직은 기간 안이면 누락이 아니며, 월 갱신 조직은 다음 인보이스를 등록하기 전 달부터 누락으로 보입니다.";
export const SEATS_HINT = "그 달에 기여한 인보이스(발행일 기준: 그 달 발행 / 기간 기준: 그 달을 덮는) 중 좌석이 적힌 마지막 장의 좌석 수(조직 합). 아래 작은 글씨는 티어(Premium/Standard)별 내역. 좌석 변경이 있으면 프로레이션 라인 중 양수(+) 라인의 수량입니다.";
...
export const PER_SEAT_HINT = "티어(Premium/Standard)별 청구 ÷ 그 티어 좌석. 단가가 다른 티어를 섞은 평균은 작은 글씨로만 보입니다. 좌석이 없는 달은 비어 있습니다.";

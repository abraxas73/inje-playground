...
export default function HowItWorks({ solutions, features, maxCandidates, llmAvailable }: {
  ...
  const steps = [
    { icon: FileSearch, title: "1. 업로드·등록", body: "hwp·hwpx·docx는 표준 요구사항 표(7행)를, xlsx는 요건표 시트(한 행 = 한 요구사항)를 규칙으로 읽습니다. 비표준 문서만 Claude가 추출합니다. 사업명·발주기관·기간·금액은 문서에서 찾아 채우고, 같은 파일·같은 사업명은 중복으로 알려 줍니다." },
